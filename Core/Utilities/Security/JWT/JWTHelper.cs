...
namespace Core.Utilities.Security.JWT
{
    ...
    {
        public IConfiguration Configuration { get; }//appsettings.json dosyasını okuyabilmek için
        ...
        //User ve user'ın claim bilgilerini parametre alarak bir claim listesi oluşturur.
