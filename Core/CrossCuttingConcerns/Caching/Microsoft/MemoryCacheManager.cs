...
namespace Core.CrossCuttingConcerns.Caching.Microsoft
{
    public class MemoryCacheManager : ICacheManager
    {
        ...
        {
            //Cache bellekte EntriesCollection ismiyle tutulur. Bellekteki EntriesCollection'ı bul 
            ...
            foreach (var cacheItem in cacheEntriesCollection)//Her bir cache elemanını gezer.
            {
